...
public class RECPSCRUDAPIServiceImpl implements RECPSCRUDAPIServiceIntf{
	...
	public String searchPatternByName(String patternName) {
		...
		Request request = new Request.Builder()
				  .url("http://recptool-hwfpgdgvakedevb0.westus3-01.azurewebsites.net/search_patterns?typeOfPatternResearch=patternResearchByName&inputPatternInformation=" + patternName)
				  .method("GET", null)
				  .build();
		try {
